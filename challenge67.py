...
class CacheNode:
    def __init__(self, key, value, freq_node, prev, nxt):
        self.key = key
        self.value = value
        self.freq_node = freq_node
        self.prev = prev  # previous CacheNode
    ...
    def free_myself(self):
        ...
        elif self.freq_node.chache_head == self:
            self.nxt.prev = None
...
class FreqNode:
    def __init__(self, freq, prev, nxt):
        self.freq = freq
        self.prev = prev  # previous FreqNode
...
class LFU_cache:
    def __init__(self, capacity):
        self.cache = dict() # {key: cache_node}
